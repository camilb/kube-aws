...
func NewDefaultCluster() *Cluster {
	...
	return &Cluster{
		DeploymentSettings: DeploymentSettings{
			...
			CalicoNodeImage:                    model.Image{Repo: "quay.io/calico/node", Tag: "v2.6.3", RktPullDocker: false},
			CalicoCniImage:                     model.Image{Repo: "quay.io/calico/cni", Tag: "v1.11.1", RktPullDocker: false},
			CalicoKubeControllersImage:         model.Image{Repo: "quay.io/calico/kube-controllers", Tag: "v1.0.1", RktPullDocker: false},
			CalicoCtlImage:                     model.Image{Repo: "quay.io/calico/ctl", Tag: "v1.6.2", RktPullDocker: false},
			...
			DnsMasqMetricsImage:                model.Image{Repo: "gcr.io/google_containers/k8s-dns-sidecar-amd64", Tag: "1.14.7", RktPullDocker: false},
